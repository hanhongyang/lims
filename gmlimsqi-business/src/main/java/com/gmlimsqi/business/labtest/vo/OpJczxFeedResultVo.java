 ...
 */
@Data
public class OpJczxFeedResultVo {
    ...
    private String a0;
    /** 状态 */
    @Excel(name = "状态",readConverterExp = "1=开始化验,2=化验完成,3=校对完成,4=审核完成,5=作废")
    ...
    /** 主要使用试剂/（配制）批号 */
    @Excel(name = "主要使用试剂/", readConverterExp = "配=制")
    ...
    private List<OpJczxFeedResultInfo> infoList;
