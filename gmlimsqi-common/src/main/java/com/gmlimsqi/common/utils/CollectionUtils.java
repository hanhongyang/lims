...
public class CollectionUtils {
    ...
    public static <T> List<T> filterList(Collection<T> from,
    ...
    public static <T, R> List<T> distinct(Collection<T> from, Function<T
            , R> keyMapper) {
        if (CollUtil.isEmpty(from)) {
            return new ArrayList<>();
        }
    ...
    public static <T, R> List<T> distinct(Collection<T> from, Function<T
            , R> keyMapper, BinaryOperator<T> cover) {
        if (CollUtil.isEmpty(from)) {
            return new ArrayList<>();
        }
        return new ArrayList<>(convertMap(from, keyMapper,
                Function.identity(), cover).values());
    }
    ...
    public static <T, K> Map<K, T> convertMap(Collection<T> from,
    ...
    public static <T, K, V> Map<K, V> convertMap(Collection<T> from,
        ...
        return convertMap(from, keyFunc, valueFunc, mergeFunction,
                HashMap::new);
    }
    ...
    public static <T, K, V> Map<K, V> convertMap(Collection<T> from,
                                                 Function<T, K> keyFunc,
                                                 Function<T, V> valueFunc, BinaryOperator<V> mergeFunction, Supplier<? extends Map<K, V>> supplier) {
        if (CollUtil.isEmpty(from)) {
            return new HashMap<>();
        }
    ...
    public static <T> Collection<T> singleton(T deptId) {
        return deptId == null ? Collections.emptyList() :
