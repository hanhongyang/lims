...
import com.gmlimsqi.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    {
        SysUserSign sysUserSign = userService.selectUserSign();
        return success(sysUserSign);
    }

    //更新签名
    @PutMapping("/sign")
    public AjaxResult updateSign(@RequestBody SysUserSign sysUserSign)
    {
        userService.updateUserSign(sysUserSign);
        return success();
    }
