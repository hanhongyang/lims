...
public class SysDeptController extends BaseController {
     ...
     * 获取部门列表
     */
    @PreAuthorize("@ss.hasPermi('system:dept:list') OR @ss.hasRole('admin') OR @ss.hasRole('jczxAdmin') " +
            "OR @ss.hasRole('mcAdmin') OR @ss.hasRole('slcAdmin')  ")
    @GetMapping("/list")
     ...
     * 根据用户查询部门和联系方式
     */
    @GetMapping(value = "/getLoginUserDept/")
    public AjaxResult getLoginUserDept() {
        return success(deptService.getLoginUserDept());
    }
    ...
    public AjaxResult getLoginUserDeptAndChildren() {
        // todo
        return success("todo");
    }
     ...
     * 界面下拉筛选框
     */
    @PreAuthorize("@ss.hasPermi('system:dept:filterDept')")
    @GetMapping("/filterDept")
    public TableDataInfo filterDept() {
        startPage();
        List<SysDept> depts = deptService.filterDept();
